...
<body>
    <div class="header">
        ...
        <ul class="inline">
            <li>
                <img src="${pageContext.request.contextPath}/images/32/avatar5.png" style="height: 32px;width: 32px" />&nbsp;&nbsp;欢迎您,${user1.username}
            </li>
            <li class="dropdown">
            ...
            <li>
                <a class="loginout" href="${pageContext.request.contextPath}/login.jsp"> <img src="${pageContext.request.contextPath}/images/32/19.png" />退出</a>
            </li>
        </ul>
    </div>
